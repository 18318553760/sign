...
$data = '{"bindKey":"8IIYer87yte0vi7p"}';
$aes = new Aes('f7rbsEwiO5bl1aTd');
...
// 加密前：{"bindKey":"8IIYer87yte0vi7p"}
// 加密后：SnnV3T1CwGb8n0qFGOlYikIHcBn/OmUVf6uHgYJS4Ks=
// 解密后：{"bindKey":"8IIYer87yte0vi7p"}